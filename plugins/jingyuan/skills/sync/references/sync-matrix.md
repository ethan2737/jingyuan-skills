...
| 变更类型 | 优先同步对象 | 说明 |
|---|---|---|
| 新增或删除核心功能 | `docs/PRD/prd.md`、`docs/PRD/changelog.md`、`docs/development/plan.md` | 先确认这是产品意图，不是临时实现或缺陷。 |
| 修改用户主流程 | PRD、`docs/design/design.md`、`docs/design/mockup.md`、Development Plan | 主流程变化通常会影响页面、状态、验收和 Phase。 |
...
| `docs/PRD/changelog.md` | PRD 的新增、修改、删除、重构澄清、关闭待确认 | 没有实际改动的流水账 |
| `docs/design/design.md` | 视觉方向、信息密度、交互风格、状态设计方向 | 具体代码实现和 Phase 任务 |
...
| 场景 | 处理方式 |
|---|---|
| Pencil MCP 可用且差异明确 | 直接更新 docs/design/ui-design.pen，截图或导出验证，再更新 docs/design/mockup.md |
| Figma MCP 可用且差异明确 | 按 docs/design/mockup.md 记录的文件定位信息更新 Figma 设计稿，再更新 docs/design/mockup.md |
