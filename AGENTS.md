...
|---|-------|------|-----------|------------|
| 0 | `setup` | Initialize project state | 鈥?| `.jingyuan/config.json`, state directories |
| 1 | `pm` | Product requirements | User interviews | `docs/PRD/prd.md` |
| 2 | `design` | Technical design | PRD, context, ADR | `docs/design/design.md` |
| 3 | `mockup` | UI mockup spec | design.md | Design Artifacts, optional `ui-design.pen` |
| 4 | `dev-plan` | Development planning | PRD, design, ADR | `docs/development/plan.md`, `docs/changes/<id>.md` |
...
- **No silent config upgrades**: Config version 1/2 → 3 migration requires preview, a clean Git repository, and explicit `-ConfirmDestructiveMigration` confirmation.
